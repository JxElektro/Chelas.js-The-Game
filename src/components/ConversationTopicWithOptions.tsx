  ...
  return (
    ...
    >
      ...
      {isLoading ? (
        ...
        <div className="win95-inset p-2 sm:p-3">
          <p className="text-sm font-medium mb-2 sm:mb-3">{topic.question}</p>
          ...
          <div className="space-y-2 mt-2 sm:mt-3">
            {topic.options.map((option, index) => (
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="bg-chelas-button-face border border-chelas-gray-dark p-1 sm:p-2 cursor-pointer hover:bg-chelas-gray-light/30"
